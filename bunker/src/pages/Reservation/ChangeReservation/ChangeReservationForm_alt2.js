...
class ChangeReservationForm extends React.Component {
	...
	handleDate = date => {
		...
		const start = moment(this.state.newReservation.start_date).format(
			"MM-DD-YYYY"
		);
	...
	render() {
		...
		const datesRange = [
			this.state.newReservation.start_date,
			this.state.newReservation.end_date
		];
								...
								<Card.Description>
									<Dropdown
										...
										defaultValue={parseInt(
											this.state.newReservation.roomQuantity
										)}
									/>
								</Card.Description>
							</Grid.Row>
							...
							<Grid.Row>
								{this.state.isUpdated ? (
									<Button
										...
										active
										onClick={event => {
											this.props.setNewReservationData(
