...
class Landing extends React.Component {
	...
	componentDidMount() {
		this._asyncRequest = this.props.firebase.test().then(result => {
			this._asyncRequest = null;
			const hotels = this.props.firebase.sortHotels(result, ["data","room_types", "0", "price"]);
			// hotels.forEach(hotel => {
				// this.props.firebase.database
				// 	.collection("hotels")
				// 	.doc("3hWqZ1f4tjzOsba5TqmS")
				// 	.update({
				// 		room_types: [
				// 			{
				// 				type: "single",
				// 				price: this.getRandomInt(100, 200),
				// 				capability: 1
				// 			},
				// 			{
				// 				type: "double",
				// 				price: this.getRandomInt(200, 400),
				// 				capability: 2
				// 			},
				// 			{
				// 				type: "multiple",
				// 				price: this.getRandomInt(500, 1000),
				// 				capability: 5
				// 			}
				// 		]
				// 	})
